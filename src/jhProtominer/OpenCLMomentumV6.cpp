...
OpenCLMomentumV6::OpenCLMomentumV6(int _HASH_BITS, int _device_num) {
	...
	// compiles
	fprintf(stdout, "Starting OpenCLMomentum V6\n");
...
//	program_filenames.push_back("opencl/cryptsha512_kernel.cl");
	program_filenames.push_back("opencl/OpenCLMomentumV6.cl");
...
OpenCLMomentumV6::~OpenCLMomentumV6() {
	// destroy
	delete hashes;
	delete hash_table;
	delete (collisions);
...
int OpenCLMomentumV6::getCollisionCeiling() {
	return (1<<8);
}
